...
import com.example.Ekittab.databinding.ActivityDashboardUserBinding;
    ...
    private void setupViewPagerAdapter(ViewPager viewPager){
        ...
        ref.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                ModelCategory modelAll = new ModelCategory("01","everyone","","1");
                ModelCategory modelMostView  = new ModelCategory("02","most watched","","1");
                ModelCategory modelMostDownload  = new ModelCategory("03","Most downloaded","","1");
...
//                    AdapterPdfUser adapterPdfUser = new AdapterPdfUser(DashboardActivity.this,categoryArrayList);
    ...
    private void checkUser() {
        ...
        if (firebaseUser == null){
            binding.tvSubtitle.setText("You are not logged in");
        }else{
