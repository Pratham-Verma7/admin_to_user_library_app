...
import com.example.Ekittab.Filter.FilterCategory;
import com.example.Ekittab.databinding.RowCategoryBinding;
    ...
    public void onBindViewHolder(@NonNull HolderCategory holder, int position) {
        ...
        holder.imageButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                builder.setTitle("Delete").setMessage("Are you sure you want to delete the category")
