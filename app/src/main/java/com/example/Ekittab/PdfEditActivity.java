...
import com.example.Ekittab.databinding.ActivityPdfEditBinding;
...
public class PdfEditActivity extends AppCompatActivity {
    ...
    private void validateData(){
        ...
        if (TextUtils.isEmpty(title)){
            Toast.makeText(PdfEditActivity.this, "Title field is empty", Toast.LENGTH_SHORT).show();
        }
        else if (TextUtils.isEmpty(description)){
            Toast.makeText(PdfEditActivity.this, "Description field is empty", Toast.LENGTH_SHORT).show();
        }
        else if (TextUtils.isEmpty(selectedId)){
            Toast.makeText(PdfEditActivity.this, "Choose a category for the book", Toast.LENGTH_SHORT).show();
        }
        else {
            updatePdf();
        }
    ...
    private void updatePdf(){
        ...
        ref.child(bookId).updateChildren(hashMap).addOnSuccessListener(new OnSuccessListener<Void>() {
            ...
            public void onSuccess(Void unused) {
                ...
                Toast.makeText(PdfEditActivity.this, "Updating information..", Toast.LENGTH_SHORT).show();
    ...
    private void categoryDialog(){
        ...
        builder.setTitle("Choose a category").setItems(categoriesArray, new DialogInterface.OnClickListener() {
            @Override
